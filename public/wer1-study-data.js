(() => {
  ...
  const scenes = {
    sA: scene([[[0,0,0],"x-",3],[[-1,0,0],"y+",2],[[-2,0,0],"y-",1]],[[-1,2,0],[-1,1,0]]),
    sB: scene([[[0,0,0],"x+",3],[[1,0,0],"y-",2],[[2,0,0],"z+",1]],[[1,-2,0],[1,-1,0]]),
    mA: scene([[[0,0,0],"x-",7],[[-2,0,0],"y+",3],[[-4,0,0],"y-",2],[[-6,0,0],"z+",2]],[[-2,3,0],[-2,2,0]]),
    mB: scene([[[0,0,0],"x+",7],[[2,0,0],"z-",3],[[4,0,0],"y+",2],[[6,0,0],"y-",2]],[[2,0,-3],[2,0,-2]]),
    bA: scene([[[0,0,0],"x-",9],[[-2,0,0],"y+",5],[[-4,0,0],"y-",4],[[-6,0,0],"z+",4],[[-8,0,0],"z-",4]],[[-2,5,0],[-2,4,0]]),
    bB: scene([[[0,0,0],"x+",9],[[2,0,0],"z-",5],[[4,0,0],"z+",4],[[6,0,0],"y+",4],[[8,0,0],"y-",4]],[[2,0,-5],[2,0,-4]]),
    dA: scene([[[0,0,0],"x-",13],[[-1,0,0],"y+",7],[[-3,0,0],"y-",5],[[-5,0,0],"z+",6],[[-7,0,0],"z-",6],[[-9,0,0],"y+",5],[[-11,0,0],"y-",5],[[-13,0,0],"z+",5]],[[-1,7,0],[-1,6,0]]),
    dB: scene([[[0,0,0],"x+",13],[[1,0,0],"z-",7],[[3,0,0],"z+",5],[[5,0,0],"y-",6],[[7,0,0],"y+",6],[[9,0,0],"z-",5],[[11,0,0],"z+",5],[[13,0,0],"y-",5]],[[1,0,-7],[1,0,-6]])
  };
  const trials = [
